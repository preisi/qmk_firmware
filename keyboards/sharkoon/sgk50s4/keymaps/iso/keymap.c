...
*/
    ...
    [_GAME] = LAYOUT_iso(
                ...
                KC_CAPS,    KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L, KC_SCLN, KC_QUOT, KC_BSLS,  KC_ENT,
                KC_LSFT, KC_NUBS,    KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH, KC_RSFT,
                KC_LCTL,   KC_NO, KC_LALT,                            KC_SPC,                             KC_RALT, MO(_CL),  KC_APP, KC_RCTL
            ),
...
/*
       ...
       ├───┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─────┤
       │     │   │   │   │   │   │Ins│   │ Up│Pau│PgU│Hom│Pri│     │
       ├─────┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┐ Ent│
       │      │   │   │   │   │   │Rol│ <-│ Do│ ->│PgD│End│VaI│    │
       ├────┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴─┬─┴───┴────┤
       │    │   │   │   │   │   │   │   │Mut│VoD│VoU│VaD│   RShift │
       ├────┼───┴┬──┴─┬─┴───┴───┴───┴───┴───┴──┬┴───┼───┴┬────┬────┤
       │    │GAME│    │                        │    │ Fn │ Mod│ Tog│
       └────┴────┴────┴────────────────────────┴────┴────┴────┴────┘
*/
    ...
    [_FL]   = LAYOUT_iso(
                ...
                _______, _______, _______, _______, _______, _______, KC_SCRL, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN,  KC_END, RGB_VAI, _______,
                _______, _______, _______, _______, _______, _______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, RGB_VAD, _______,
                _______,    GAME, _______,                           _______,                             _______, MO(_FL), RGB_MOD, RGB_TOG
            ),
...
*/
    ...
    [_CL]   = LAYOUT_iso(
                ...
                _______, _______, _______, _______, _______, _______, KC_SCRL, KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN,  KC_END, RGB_VAI, _______,
                _______, _______, _______, _______, _______, _______, _______, _______, KC_MUTE, KC_VOLD, KC_VOLU, RGB_VAD, _______,
                _______,    BASE, _______,                           _______,                             _______, MO(_CL), RGB_MOD, RGB_TOG
            ),
